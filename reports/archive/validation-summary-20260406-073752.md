...
**Generated:** 2026-04-06T07:37:52.837265Z  
**Total Modules:** 3
...
```json
{
  "timestamp": "2026-04-06T07:37:52.837265Z",
  "totalModules": 3,
  "validModules": 3,
  "invalidModules": 0,
  "warningsCount": 2,
  ...
  "warnings": [
    ...
    },
    {
      "module": "legacy-tls-library",
      "file": "modules/data-in-transit/legacy-tls-library.yaml",
      "message": "FIPS 140-2 acceptance ends in 167 days (September 21, 2026). Plan migration to FIPS 140-3."
    }
  ],
  "results": [
    {
    ...
    },
    {
      ...
      "warnings": [
        ...
        "FIPS 140-2 acceptance ends in 167 days (September 21, 2026). Plan migration to FIPS 140-3."
      ]
    }
  ]
}
